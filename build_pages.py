    ...
    <div class="relative w-[1100px] h-[650px] max-w-[95vw] max-h-[90vh] flex items-center justify-center">
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center p-4 sm:p-10 overflow-hidden" style="top: 21.5%; left: 16.3%; width: 67.2%; height: 56.9%;">
            <div class="flex items-center space-x-2 sm:space-x-4 mb-4 sm:mb-10 border border-white/20 bg-black/40 px-3 sm:px-6 py-2 shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
                ...
                <h1 class="font-display-lg-mobile text-lg sm:text-2xl text-white tracking-[0.1em] glow-text">{page_title}</h1>
            </div>

            <p class="text-center font-body-base text-sm sm:text-[20px] text-[#b0d8e0] leading-[1.4] sm:leading-[1.8] max-w-xl tracking-wide opacity-90 text-shadow-sm">
                {page_text}
            </p>
        </div>
