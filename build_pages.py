...
<body class="antialiased relative font-body-base">
    ...
    <div class="relative w-[95vw] max-w-[1100px] flex items-center justify-center" style="aspect-ratio: 1100/650;">
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center p-4 sm:p-10 overflow-hidden" style="top: 21.5%; left: 16.3%; width: 67.2%; height: 56.9%;">
            <div class="flex items-center space-x-2 sm:space-x-4 mb-4 sm:mb-10 border border-white/20 bg-black/40 px-3 sm:px-6 py-2 shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
                ...
                <h1 class="font-display-lg-mobile text-sm sm:text-lg md:text-2xl text-white tracking-[0.1em] glow-text">{page_title}</h1>
            </div>

            <p class="text-center font-body-base text-xs sm:text-sm md:text-[20px] text-[#b0d8e0] leading-[1.4] sm:leading-[1.8] max-w-xl tracking-wide opacity-90 text-shadow-sm overflow-y-auto">
                {page_text}
            </p>
        </div>

        <div class="absolute left-1/2 -translate-x-1/2 z-30" style="bottom: 6.7%;">
            <a href="index.html" class="flex items-center space-x-2 border-[1.5px] border-white/30 px-4 sm:px-6 py-1 sm:py-[6px] bg-[#020b14]/80 hover:bg-[#00e5ff]/20 text-[#a2d8e4] hover:text-white font-label-caps uppercase tracking-widest transition-all shadow-[0_0_10px_rgba(0,229,255,0.2)]">
                <span class="material-symbols-outlined text-sm sm:text-base">arrow_back</span>
                <span class="text-[10px] sm:text-[13px]">BACK</span>
            </a>
        </div>
    </div>
